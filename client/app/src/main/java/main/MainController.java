...
public class MainController {
    ...
    public void initialize() {
        ...
        Button addBtn = SvgBtnCreator.cretaeBtn(svgAdd, 40);
        ...
        Button settingsBtn = SvgBtnCreator.cretaeBtn(svgSettings, 40);
        ...
        Button logoutBtn = SvgBtnCreator.cretaeBtn(svgLogout, 40);
